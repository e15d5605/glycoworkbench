...
public class GAGType {
    ...
    family         = tokens.get(0);
    motif          = tokens.get(1);
    unit_size      = Integer.parseInt(tokens.get(2));
    acetyl_pos     = parsePositions(tokens.get(3));
    opt_acetyl_pos = parsePositions(tokens.get(4));
    sulfate_pos    = parsePositions(tokens.get(5));
